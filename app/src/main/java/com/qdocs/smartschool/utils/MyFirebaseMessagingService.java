        ...
        if (remoteMessage != null)
        {
            ...
            try {
                switch (action) {
                    ...
                    case "exam" :
                        intent = new Intent(this, com.qdocs.smartschool.students.StudentExaminationList.class);
                        break;

                    case "homework" :
                        intent = new Intent(this, com.qdocs.smartschool.students.StudentHomework.class);
                        break;

                    default:
                        intent = new Intent(this, com.qdocs.smartschool.students.NotificationList.class);
                        break;
                }
           ...
           // mMessage= "The white background issue with notification messages is known and is being fixed, the fix should be released soon. Another option is to use data messages and manage the creation of the notification yourself in the onMessageReceived callback.";
            ...
            DatabaseHelperCopy dataBaseHelper = new DatabaseHelperCopy(MyFirebaseMessagingService.this);
